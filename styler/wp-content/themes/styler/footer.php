            <footer class="footer footer_mod-a wow bounceInUp" data-wow-duration="2s">
                <div class="footer-top">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3"> <img src="<?= get_stylesheet_directory_uri()  ?>/assets/img/logo_mod-a.png" height="51" width="162" alt="Logo">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <ul class="list-payments list-unstyled">
                                    <li class="list-payments__item"><a href="javascript:void(0);"><img src="<?= get_stylesheet_directory_uri()  ?>/assets/media/payments/1.jpg" height="22" width="32" alt="payments"></a></li>
                                    <li class="list-payments__item"><a href="javascript:void(0);"><img src="<?= get_stylesheet_directory_uri()  ?>/assets/media/payments/2.jpg" height="22" width="32" alt="payments"></a></li>
                                    <li class="list-payments__item"><a href="javascript:void(0);"><img src="<?= get_stylesheet_directory_uri()  ?>/assets/media/payments/3.jpg" height="22" width="32" alt="payments"></a></li>
                                    <li class="list-payments__item"><a href="javascript:void(0);"><img src="<?= get_stylesheet_directory_uri()  ?>/assets/media/payments/4.jpg" height="22" width="32" alt="payments"></a></li>
                                    <li class="list-payments__item"><a href="javascript:void(0);"><img src="<?= get_stylesheet_directory_uri()  ?>/assets/media/payments/5.jpg" height="22" width="32" alt="payments"></a></li>
                                    <li class="list-payments__item"><a href="javascript:void(0);"><img src="<?= get_stylesheet_directory_uri()  ?>/assets/media/payments/6.jpg" height="22" width="32" alt="payments"></a></li>
                                </ul>
