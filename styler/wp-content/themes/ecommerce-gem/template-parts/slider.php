...
$slider_overlay_status   		= ecommerce_gem_get_option( 'slider_overlay_status' );
		...
		if ( $slider_posts->have_posts() ) : ?>
			...
			<div class="main-slider" data-slick='<?php echo $slick_args_encoded; ?>'>
				...
				while ( $slider_posts->have_posts() ) : 
					...
					?>
					<div class="item" style="background: url(<?php echo esc_url( $image_array[0]); ?>); background-size: cover; background-position: center center;">
