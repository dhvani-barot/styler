...
for ( $i = 1; $i <= $slider_number; $i++ ) {
	...
	$wp_customize->add_control( "theme_options[slider_page_$i]",
		array(
			'label'           => esc_html__( 'Select Slide', 'ecommerce-gem' ),
			'section'         => 'section_slider',
			'type'            => 'dropdown-pages',
			'active_callback' => 'ecommerce_gem_is_featured_slider_active',
			'priority' 		  => 100,
...
$wp_customize->add_section( 'section_slider_options',
	array(
		'title'      => esc_html__( 'Slider Effects Setting', 'ecommerce-gem' ),
		'panel'      => 'slider_option_panel',
	)
);
...
$wp_customize->add_section( 'section_slider_elements',
	array(
		'title'      => esc_html__( 'Slider Elements On/Off', 'ecommerce-gem' ),
		'panel'      => 'slider_option_panel',
	)
);
...
$wp_customize->add_setting( 'theme_options[slider_overlay_status]',
	array(
		'default'           => $default['slider_overlay_status'],
		'sanitize_callback' => 'ecommerce_gem_sanitize_checkbox',
	)
);
$wp_customize->add_control( 'theme_options[slider_overlay_status]',
	array(
		'label'           => esc_html__( 'Enable Overlay', 'ecommerce-gem' ),
		'section'         => 'section_slider_elements',
		'type'            => 'checkbox',
	)
);